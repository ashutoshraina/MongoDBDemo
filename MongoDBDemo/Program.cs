namespace MongoDBDemo
{
	...
	class Program
	{
		...
		public static void SeedData()
		{
			...
			var question1 = new Question{Text = "Who are you ?", Answer = "I am MongoDB.", CreatedOn = DateTime.Now, Difficulty = 3};
			var question2 = new Question{Text = "What kind of db are you ?", Answer = "I am a document database.", CreatedOn = DateTime.Now, Difficulty = 3};
			var question3 = new Question{Text = "How fast are you ?", Answer = "I am kind of super quick.",	CreatedOn = DateTime.Now, Difficulty = 2};
			var question4 = new Question{Text = "Where are we right now?", Answer = "We are in Pune.",	CreatedOn = DateTime.Now, Difficulty = 4};
