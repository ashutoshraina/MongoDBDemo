namespace MongoDBDemo
{
	...
	internal class Program {
		...
		public static void ShowOptimisticConcurrency () {
			...
			var person = ocQuery.GetPerson();
			Console.WriteLine(string.Format("Id : {0} Name : {1} Version : {2}", person.Id, person.Name, person.Version));
			...
			if ( ocQuery.EditPerson(person) ) {
				...
				var changedPerson = ocQuery.GetPerson();
				Console.WriteLine("New Version is :" + changedPerson.Version);
			}
		}
